...
Once you wish to get started contributing to the code base, please refer to our [development guide](https://github.com/projectcapsule/capsule/blob/main/DEVELOPMENT.md) for a how-to. **[We accept pull requests from forks only](#create-a-pull-request)**.
...
When creating a pull request, please visit:
  ...
  * [commits](/project/contributions/guidelines/#commits)
