...
Have you tried Capsule or are you using it in your project or company? Please consider adding your project/company to the list of adopters. This helps the Capsule community understand who is using Capsule and how it is being used.

## Adding yourself

In the [adopters.yaml](https://github.com/projectcapsule/capsule/blob/main/ADOPTERS.md) file you can add yourself as an adopter of the project. It’s enough to add an entry for your company, and upon merging it will automatically be added to our website. To add your organization, follow these steps:

  1. Fork the [projectcapsule/website](https://github.com/projectcapsule/website/fork) project to your personal space.

  2. Clone it locally with `git clone https://github.com/<YOUR-GH-USERNAME>/website.git capsule-website`.
  ...
  3. Open a Pull Request to [projectcapsule/website](https://github.com/projectcapsule/website/pulls) and a preview build will turn up.
