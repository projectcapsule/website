...
- **Templated resource distribution** - using [Replications](/docs/replications/), resources such as NetworkPolicies, ImagePullSecrets, and LimitRanges are automatically distributed into every namespace a Tenant Owner creates, using Go templates for dynamic values like namespace name or tenant name.
